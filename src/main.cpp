...
unsigned int nStakeTargetSpacing = 7 * 60; // 1-minute stakes spacing
...
const string strMessageMagic = "UssrUnit Signed Message:\n";
...
{
    return MAX_MINT_PROOF_OF_WORK + nFees;
    ...
    // UssrUnit: subsidy is cut in half every 64x multiply of PoW difficulty
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("ussrunit-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UssrUnit
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // UssrUnit: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    int nMaxOffset = 31 * nOneDay; // 1 month
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UssrUnit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const string strTimestamp = "Without Brailsford there is no Team Sky bbc 2017";
        CTransaction txNew;
        txNew.nTime = 1489441201;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1489441201;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2257685 : 122854;

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x6ecd9540accb440c3ffaee1e09a20ad33fe87d8075dfd02314dc9ebbb5429b70"));
        block.print();
