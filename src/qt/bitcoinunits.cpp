...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("USSR");
    case mBTC: return QString("mUSSR");
    case uBTC: return QString::fromUtf8("μUSSR");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("UssrCoins"));
    case mBTC: return QString(QObject::tr("Milli-UssrCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-UssrCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
