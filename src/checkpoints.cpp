...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,     std::make_pair(hashGenesisBlock, 1489441201) )
		( 500, std::make_pair(uint256("0x000006b371d21475482704f587e7394b31a05b0c44b2872b5164110b822df3e2"), 1489496031) )
    ;
    ...
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1489441201) )
        ;
