Ussrcoin-qt: Qt4 GUI for Ussrcoin
===============================
...
Alternatively, install Qt Creator and open the `ussrunit-qt.pro` file.

An executable named `ussrunit-qt` will be built.
...
A warning for people using the *static binary* version of Ussrcoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Ussrcoin is linked against libdb5.3.
...
installed causes ussrunit-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
